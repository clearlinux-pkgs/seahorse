...
Source0  : https://download.gnome.org/sources/seahorse/43/seahorse-43.0.tar.xz
...
Patch1: 0001-Allow-2.4.0-for-gpg.patch
...
%prep
%setup -q -n seahorse-43.0
cd %{_builddir}/seahorse-43.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688580287
