...
Source0  : https://download.gnome.org/sources/seahorse/40/seahorse-40.0.tar.xz
...
%prep
%setup -q -n seahorse-40.0
cd %{_builddir}/seahorse-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619120857
...
cp %{_builddir}/seahorse-40.0/COPYING %{buildroot}/usr/share/package-licenses/seahorse/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/seahorse-40.0/COPYING-DOCS %{buildroot}/usr/share/package-licenses/seahorse/c61905dc64311e8bcee6afc425fa40f917a45131
cp %{_builddir}/seahorse-40.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
