...
Source0  : https://download.gnome.org/sources/seahorse/47/seahorse-47.0.1.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : CC-BY-SA-3.0 GPL-2.0 LGPL-2.1
...
%prep
%setup -q -n seahorse-47.0.1
cd %{_builddir}/seahorse-47.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726782615
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dkey-sharing=false \
-Dmanpage=true \
...
cp %{_builddir}/seahorse-%{version}/COPYING-DOCS %{buildroot}/usr/share/package-licenses/seahorse/77788fdc4412a319a4538d963edd83385fd23fdd || :
...
/usr/share/package-licenses/seahorse/77788fdc4412a319a4538d963edd83385fd23fdd
