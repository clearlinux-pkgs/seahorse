...
Source0  : https://download.gnome.org/sources/seahorse/3.30/seahorse-3.30.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.1 GPL-2.0 LGPL-2.1
Requires: seahorse-bin
Requires: seahorse-data
Requires: seahorse-license
Requires: seahorse-locales
Requires: seahorse-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1536132206
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain -Dkey-sharing=false  builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/seahorse
cp COPYING %{buildroot}/usr/share/doc/seahorse/COPYING
cp COPYING-DOCS %{buildroot}/usr/share/doc/seahorse/COPYING-DOCS
cp COPYING.LIB %{buildroot}/usr/share/doc/seahorse/COPYING.LIB
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/seahorse/COPYING
/usr/share/doc/seahorse/COPYING-DOCS
/usr/share/doc/seahorse/COPYING.LIB
