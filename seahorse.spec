...
License  : GFDL-1.1 GPL-2.0 GPL-3.0 LGPL-2.1 LGPL-2.1+
...
%prep
%setup -q -n seahorse-3.36.2
cd %{_builddir}/seahorse-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595366434
...
cp %{_builddir}/seahorse-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/seahorse/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/seahorse-3.36.2/COPYING-DOCS %{buildroot}/usr/share/package-licenses/seahorse/c61905dc64311e8bcee6afc425fa40f917a45131
cp %{_builddir}/seahorse-3.36.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/seahorse-3.36.2/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/seahorse-3.36.2/subprojects/libhandy/debian/copyright %{buildroot}/usr/share/package-licenses/seahorse/d295f3a9ec2407b00d9f397ce11fb432ae071dd2
...
/usr/share/package-licenses/seahorse/d295f3a9ec2407b00d9f397ce11fb432ae071dd2
