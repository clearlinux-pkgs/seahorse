...
Source0  : https://download.gnome.org/sources/seahorse/3.38/seahorse-3.38.1.tar.xz
...
%prep
%setup -q -n seahorse-3.38.1
cd %{_builddir}/seahorse-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613505352
...
cp %{_builddir}/seahorse-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/seahorse/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/seahorse-3.38.1/COPYING-DOCS %{buildroot}/usr/share/package-licenses/seahorse/c61905dc64311e8bcee6afc425fa40f917a45131
cp %{_builddir}/seahorse-3.38.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/seahorse-3.38.1/subprojects/libhandy/COPYING %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/seahorse-3.38.1/subprojects/libhandy/debian/copyright %{buildroot}/usr/share/package-licenses/seahorse/4edf9bbb2cfc4d22f89ac2a08f41edd324a68320
