...
%prep
%setup -q -n seahorse-41.0
cd %{_builddir}/seahorse-41.0
...
cp %{_builddir}/seahorse-41.0/COPYING %{buildroot}/usr/share/package-licenses/seahorse/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/seahorse-41.0/COPYING-DOCS %{buildroot}/usr/share/package-licenses/seahorse/c61905dc64311e8bcee6afc425fa40f917a45131
cp %{_builddir}/seahorse-41.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/seahorse/01a6b4bf79aca9b556822601186afab86e8c4fbf
